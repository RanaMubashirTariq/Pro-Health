            ...
            >
              <CardContent className="p-0">
                <div className="flex flex-col h-full">
                  <div className="flex items-center gap-6 mb-11 max-[500px]:mb-5">
                    <div className="w-[120px] h-[120px] flex-shrink-0  max-[1550px]:w-[100px] max-[1550px]:h-[100px] max-[800px]:w-[90px] max-[800px]:h-[90px] max-[500px]:w-[70px] max-[500px]:h-[70px]">
                      <img className="w-full h-full" src={award.imageAlt} alt={award.imageAlt} />
                    </div>
                    <h3 className="font-['Poppins'] font-medium text-[#083124] text-xl max-[1600px]:text-[18px] max-[370px]:text-[14px] max-[370px]:leading-[24px]  leading-[30px] max-[500px]:text-[16px] max-[500px]:leading-[28px]">
                      {award.title}
                    </h3>
                  </div>
                  <p className="opacity-50 font-['Poppins'] text-base max-[370px]:text-[13px] max-[370px]:leading-[20px] leading-[26px] font-normal text-[#083124] over-flow:hidden text-ellipsis line-clamp-5 max-[500px]:text-[14px] max-[500px]:leading-[24px]">
                    {award.description}
                  </p>
                </div>
              </CardContent>
