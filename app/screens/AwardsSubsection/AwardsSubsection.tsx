...
export default function AwardsSubsection  () {
  ...
  return (
    <section className="w-full py-[200px] max-[1500px]:py-[100px]  max-[1000px]:py-[40px]   px-[150px] max-[1800px]:px-[250px] max-[1500px]:px-[50px] max-[1000px]:px-[25px]  ">
        ...
        <div className="flex items-center justify-center flex-wrap gap-5 max-[1900px]:gap-[100px]  max-[1000px]:gap-[20px]   w-full mx-auto">
              ...
              <CardContent className="p-0">
                <div className="flex flex-col h-full">
                  <div className="flex items-center gap-6 mb-11">
                    <div className="w-[120px] h-[120px] flex-shrink-0 max-[800px]:w-[90px] max-[800px]:h-[90px]">
                      <img className="w-full h-full" src={award.imageAlt} alt={award.imageAlt} />
                    </div>
                    <h3 className="font-['Poppins'] font-medium text-[#083124] text-xl max-[767px]:text-[18px] leading-[30px]">
                      {award.title}
                    </h3>
                  </div>
