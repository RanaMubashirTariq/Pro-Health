          ...
          {departments.map((department, index) => {
            ...
            return (
              <Card
                ...
                className={`w-full max-w-[253px] max-[1000px]:max-w-[300px] max-[800px]:max-w-[280px] max-[767px]:max-w-[100%] h-[290px] max-[1350px]:h-[230px] max-[767px]:h-auto rounded-[20px] transition-all duration-300 border-none [box-shadow:0px_4px_21px_1px_#307BC41A] ${
                  isActive
