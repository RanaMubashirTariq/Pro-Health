...
const departments = [
  ...
  return ( 
     <section className="relative w-full max-w-[1922px]  h-[571px] max-[1350px]:h-[471px] mt-[103px] max-[1000px]:mt-[60px] max-[767px]:mt-10 px-[123px] max-[1500px]:px-[50px] max-[1000px]:px-[25px] max-[1200px]:h-[700px]  max-[1000px]:h-[1050px] max-[900px]:h-[1000px] max-[767px]:h-[1450px] ">
    <div className="relative w-full h-[449px] max-[1350px]:h-[350px] max-[1000px]:h-[250px]  py-24  bg-custom-gradient rounded-[25px] overflow-hidden">
               ...
               <img src="/vector-4.svg" className="absolute top-0 right-0 w-[623px] h-[655px] z-0" alt="" />
                 ...
                 <div className="w-full max-w-[1618px]  px-[13px] max-[1800px]:px-[70px]  max-[767px]:px-[25px] absolute top-[110px] left-1/2 max-[1500px]:top-[110px] max-[1350px]:top-[60px] max-[1100px]:top-[110px] max-[900px]:top-[60px] -translate-x-1/2 z-10 mx-auto">
          ...
          {departments.map((department, index) => {
            ...
            return (
              <Card
                ...
                className={`cursor-pointer w-full max-w-[253px] max-[1000px]:max-w-[300px] max-[800px]:max-w-[280px] max-[767px]:max-w-[100%] h-[290px] max-[1350px]:h-[230px] max-[767px]:h-auto rounded-[20px] transition-all duration-300 border-none [box-shadow:0px_4px_21px_1px_#307BC41A] ${
                  isActive
