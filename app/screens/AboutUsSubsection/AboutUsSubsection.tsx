        ...
        <div className="flex items-center justify-between gap-[92px] w-full max-[1100px]:flex-col max-[1100px]:gap-[20px] ">
          ...
          <Card className="w-full max-w-[596px]  max-[1300px]:max-w-[100%] border-none shadow-none bg-transparent">
            <CardContent className="p-0">
              <h2 className="max-[1300px]:pt-[30px] font-['Figtree'] font-bold text-[72px] max-[1500px]:text-[56px] max-[1500px]:leading-[66px] max-[1100px]:text-[36px] max-[1000px]:leading-[46px] leading-[82px] text-[#083124] tracking-[0]">
                About Us
              </h2>

              <h3 className="mt-4 font-['Figtree'] font-semibold text-[32px] max-[1000px]:text-[24px] max-[1000px]:leading-[32px] leading-[50px] text-[#083124] tracking-[0]">
                PRO HEALTH
              </h3>
              ...
              <div className="mt-[124px] max-[1300px]:mt-[76px] max-[1100px]:mt-[26px] flex item-start">
                ...
                <p className="pl-[29px] font-['Figtree'] font-normal text-[#08312485] text-[32px] max-[1000px]:text-[24px] max-[1100px]:leading-[32px] tracking-[0] leading-[42px]">
                  ProHealth is a team of experienced medical professionals
                </p>
              </div>

              <p className="mt-8 pl-16 max-[1300px]:mt-5 max-[1100px]:pl-14 font-['Poppins'] text-xl leading-[26px] font-normal max-[1000px]:text-[18px] text-[#08312485] ">
